...
const Header = () => {
  return (
    ...
    <Link to='https://discord.gg/7nFhsZgmtU' className='z-[2]'><button className='ring-2 ring-neutral-300 rounded-lg py-3 px-16 font-Inter font-semibold text-base md:max-xl:mb-8 z-[2]  hover:bg-zinc-100 hover:text-black hover:cursor-pointer'>Join Us</button></Link>
    </div>

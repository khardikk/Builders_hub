...
const Header = () => {
  return (
    ...
    <p className='text-3xl font-light leading-normal  my-5'>We are a community of builders and we believe in building projects that we do not leave in between. 

...
const Header = () => {
  return (
    <div className='flex justify-center items-center h-screen mb-24 max-sm:mb-0 max-md:mb-0'>
    ...
    <h1  className="bg-gradient-to-b from-white via-slate-200 to-slate-300 inline-block text-transparent bg-clip-text text-8xl font-bold font-Inter leading-none max-[480px]:text-5xl max-md:text-6xl max-md:mb-4 ">

  ...
  return (
    <div data-aos="fade-up" data-aos-duration="1500" id='about-section' className="flex flex-row justify-between mt-8 mb-20  max-[480px]:flex-col-reverse max-[480px]:items-center max-[480px]:mb-10 md:max-xl:flex md:max-xl:flex-col-reverse">
      <div className="flex flex-col w-[51.375rem] max-[480px]:w-full md:max-xl:w-full">
        ...
        <p className="text-left w-[45rem] font-DMSans text-2xl leading-relaxed mb-8  max-[480px]:text-base  max-[480px]:w-[315px] max-[480px]:text-center max-[480px]:mt-5 md:max-xl:w-[38rem]">{memberIntro}</p>

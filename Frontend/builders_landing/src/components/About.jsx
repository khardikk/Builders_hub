...
const AboutComponent = ({ memberName, memberIntro, twitterLink, linkedinLink, githubLink, memberImage }) => {
  return (
    <div data-aos="fade-up" data-aos-duration="1500" id='about-section' className="flex flex-row justify-between mt-8 mb-20  max-[480px]:flex-col-reverse max-[480px]:items-center max-[480px]:mb-10 md:max-lg:flex md:max-lg:flex-col-reverse">
      <div className="flex flex-col w-[51.375rem] max-[480px]:w-full md:max-lg:w-full">
        <h4 className="text-left mb-10 font-Inter font-bold text-4xl max-[480px]:text-center">{memberName}</h4>
        <p className="text-left w-[45rem] font-DMSans text-2xl leading-relaxed mb-8  max-[480px]:text-base  max-[480px]:w-[315px] max-[480px]:text-center max-[480px]:mt-5 md:max-lg:w-[38rem]">{memberIntro}</p>
      ...
      <div className="flex ml-10 max-[480px]:ml-2 md:max-lg:flex md:max-lg:justify-center md:max-lg:items-center">
